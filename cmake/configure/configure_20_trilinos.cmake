...
macro(feature_trilinos_configure_external)
  ...
  if(${DEAL_II_TRILINOS_WITH_TPETRA})
    if(DEAL_II_HAVE_TPETRA_INST_DOUBLE)
      ...
      set(DEAL_II_EXPAND_TPETRA_SPARSE_MATRIX_DOUBLE "LinearAlgebra::TpetraWrappers::SparseMatrix<double>")
    endif()
    if(DEAL_II_HAVE_TPETRA_INST_FLOAT)
      set(DEAL_II_EXPAND_TPETRA_VECTOR_FLOAT "LinearAlgebra::TpetraWrappers::Vector<float>")
      set(DEAL_II_EXPAND_TPETRA_SPARSE_MATRIX_FLOAT "LinearAlgebra::TpetraWrappers::SparseMatrix<float>")
    endif()
    if(${DEAL_II_WITH_COMPLEX_NUMBERS})
      if(DEAL_II_HAVE_TPETRA_INST_COMPLEX_DOUBLE)
        ...
        set(DEAL_II_EXPAND_TPETRA_SPARSE_MATRIX_COMPLEX_DOUBLE "LinearAlgebra::TpetraWrappers::SparseMatrix<std::complex<double>>")
      endif()
      if(DEAL_II_HAVE_TPETRA_INST_COMPLEX_FLOAT)
        ...
        set(DEAL_II_EXPAND_TPETRA_SPARSE_MATRIX_COMPLEX_FLOAT "LinearAlgebra::TpetraWrappers::SparseMatrix<std::complex<float>>")
      endif()
    endif()
  endif()
