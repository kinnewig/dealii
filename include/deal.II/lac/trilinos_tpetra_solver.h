...
#  endif
    ...
    template <typename Number = double, typename Node = Tpetra::KokkosClassic::DefaultNode::DefaultNodeType>
    class SolverTpetra : public SolverBase<Number,
                                           Node,
                                           Tpetra::Operator<Number, int, dealii::types::signed_global_dof_index, Node>,
                                           Tpetra::MultiVector<Number, int, dealii::types::signed_global_dof_index, Node>>
    {
    public:

      using VectorType =
        Tpetra::Vector<Number, int, dealii::types::signed_global_dof_index, Node>;
    ...
    private:
      using SolverBase<Number, Node, LinearOperatorType, MultiVectorType>::parameter_list;
      using SolverBase<Number, Node, LinearOperatorType, MultiVectorType>::linear_problem;
      using SolverBase<Number, Node, LinearOperatorType, MultiVectorType>::solver;
      using SolverBase<Number, Node, LinearOperatorType, MultiVectorType>::do_solve;
    ...
    template <typename Number = double, typename Node = Tpetra::KokkosClassic::DefaultNode::DefaultNodeType>
    class SolverXpetra : public SolverBase<Number,
                          Node,
                          ...
                          Xpetra::MultiVector<Number, int, dealii::types::signed_global_dof_index, Node>>
    {
      public:
        ...
        using XpetraTpetraMultiVectorType =
          Xpetra::TpetraMultiVector<Number, int, dealii::types::signed_global_dof_index, Node>;
