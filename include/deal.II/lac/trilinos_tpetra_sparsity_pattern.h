  ...
  namespace TpetraWrappers
  {
    namespace SparsityPatternIterators
    {
      ...
      public:
         ...
         */
        using size_type =
          unsigned long int; // dealii::types::signed_global_dof_index;
      ...
      private:
        ...
        friend class TpetraWrappers::SparsityPattern;
      };
...
#  ifndef DOXYGEN
                                 ...
                                 const bool /*indices_are_sorted*/)
    {
      ...
      Teuchos::ArrayView<const long long> array(col_index_ptr, n_cols);
