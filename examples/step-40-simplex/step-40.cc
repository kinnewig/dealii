...
*/
    ...
    // but only refine is implemented for triangles
//    GridRefinement::refine_and_coarsen_fixed_number(
      triangulation, estimated_error_per_cell, 0.2, 0.0);
    triangulation.execute_coarsening_and_refinement();
  }
  ...
  void LaplaceProblem<dim>::output_results(const unsigned int cycle)
  {
    ...
    data_out.add_data_vector(locally_relevant_solution, "u", DataOut_DoFData<dim,dim>::type_dof_data);
