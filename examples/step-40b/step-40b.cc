...
// The reworked Tpetra Vector class
#include <deal.II/lac/trilinos_tpetra_vector.h>

// The new Tpetra SparseMatrix Class
#include <deal.II/lac/trilinos_tpetra_sparse_matrix.h>

// temporary Tpetra Solver
...
namespace Step40
{
  ...
  void LaplaceProblem<dim>::solve()
  {
    ...
    // generate an empty parameter list
    ...
    // create the Tpetra based solver
    LinearAlgebra::TpetraWrappers::SolverTpetra<double, Tpetra::KokkosClassic::DefaultNode::DefaultNodeType>
      solver(solver_control, parameter_list);

    // Prepare the Ifpack2 Preconditioner
    LinearAlgebra::TpetraWrappers::PreconditionRILUK<double> preconditioner;
